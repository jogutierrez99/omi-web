...
const formats = [
  { name:"500 ml", copy:"Práctica y ligera, ideal para llevar a donde vayas.", src:"/images/products/water-500ml.png", alt:"Botella OMI de 500 mililitros" },
  { name:"1,5 L", copy:"El tamaño perfecto para acompañar tu día.", src:"/images/products/water-1-5l.png", alt:"Botella OMI de 1,5 litros" },
  { name:"5 L", copy:"Comodidad y rendimiento para tu hogar.", src:"/images/products/water-5l.png", alt:"Botellón OMI de 5 litros" },
  { name:"18 L", copy:"Nuestro formato de mayor capacidad.", src:"/images/products/water-18l.png", alt:"Botellón OMI de 18 litros" },
];
